...
modsuit-ui-remaining-time = Осталось времени
modsuit-ui-time-core = [ЯДРО]
modsuit-ui-time-hours = INFO:{$hours}ч {$minutes}м
modsuit-ui-time-minutes = INFO:{$minutes}м {$seconds}с
modsuit-ui-time-extensive = INFO:{$hours}ч+
modsuit-ui-time-critical = CRIT:{$seconds}с
modsuit-ui-time-infinite = INFO:БЕСКОНЕЧНО
modsuit-ui-time-depleted = WARN:ИСТОЩЕНО
