lavaland-artefacts-rod-already-bound = Жезл уже привязан к другому носителю!
lavaland-artefacts-rod-oath-start = Вы начинаете произносить клятву Асклепия...
lavaland-artefacts-rod-bound = Жезл привязывается к руке {$target}!
...
lavaland-artefacts-ship-in-bottle-returned = Вы возвращаете лодку обратно в бутылку.
lavaland-artefacts-ship-in-bottle-not-water = Лодка может быть размещена только на воде!
lavaland-artefacts-ship-in-bottle-too-far = Лодка слишком далеко, чтобы вернуть её в бутылку.
