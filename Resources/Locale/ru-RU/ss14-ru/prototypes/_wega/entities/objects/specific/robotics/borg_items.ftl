...
ent-TelescopicShieldBorgSyndCr20 = универсальная броня синдиборгов
...
ent-BorgGeneratorNanopastXenoborg = генератор нанопасты ксеноборгов
    .desc = Устройство для генерации тюбиков нанопасты, позволяющая экстренно залатать дыры у синтетиков.
ent-XenoborgModuleBag = синтетическое хранилище для частией ксеноборгов
    .desc = Сумочка с модулями и батарейками, чтоб обслужить брата за мгновения! В хранилище встроенна отвёртка.
