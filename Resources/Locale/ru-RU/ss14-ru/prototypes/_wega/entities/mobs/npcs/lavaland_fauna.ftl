ent-MobGoliathBaby = маленький голиаф
    .desc = Маленький и медлительный молодой голиаф. Несмотря на свои размеры, он все еще может использовать щупальца, чтобы заманить добычу в ловушку.
