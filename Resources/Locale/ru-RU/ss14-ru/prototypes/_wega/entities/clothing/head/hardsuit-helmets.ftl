ent-ClothingHeadHelmetHardsuitVoid = шлем пустотного скафандра
    .desc = Старый потрепанный шлем пустотного скафандра.
ent-ClothingHeadHelmetHardsuitVoidAdvanced = улучшенный шлем пустотного скафандра
