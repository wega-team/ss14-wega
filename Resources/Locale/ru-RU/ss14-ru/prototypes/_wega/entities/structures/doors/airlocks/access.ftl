...
ent-AirlockLavalandAvanpostGlassLocked = { ent-AirlockSalvageGlass }
    .suffix = Аванпост, Закрыт
    .desc = { ent-AirlockSalvageGlass.desc }
ent-AirlockBlueShieldOfficerLocked = { ent-AirlockCommand }
    .suffix = Офицер Синий Щит, Закрыт
    .desc = { ent-AirlockCommand.desc }
ent-AirlockBlueShieldOfficerGlassLocked = { ent-AirlockCommandGlass }
    .suffix = Офицер Синий Щит, Закрыт, Стеклянный
