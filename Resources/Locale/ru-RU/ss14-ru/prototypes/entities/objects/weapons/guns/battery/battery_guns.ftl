...
ent-WeaponEnergyShotgun = энергетический дробовик
    .desc = Прототип энергетического оружия, использующий различные конфигурации дробовика. Оно позволяет совершать как смертельные, так и несмертельные выстрелы, что делает его универсальным оружием.
    .suffix = Дробовик
