...
ent-EnergyShield = энергощит
    .desc = Экзотический энергетический щит, в сложенном состоянии может поместиться даже в кармане. Незабывайте калибровать поле мультитулом после боевых столкновений. 
