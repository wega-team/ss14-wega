...
ent-ClothingEyesHudCommand = административный визор
    .desc = Окуляр с индикатором на стекле, который сканирует гуманоидов, находящихся в поле зрения, и предоставляет точные данные о статусе их ID, наличии импланта "Щит разума" и криминальном статусе.
# Corvax-Wega-End
