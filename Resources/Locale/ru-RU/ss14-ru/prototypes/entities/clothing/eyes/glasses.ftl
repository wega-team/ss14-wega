...
ent-ClothingEyesGlassesCommand = административные очки
    .desc = Модернизированные солнцезащитные очки, обеспечивающие защиту от вспышек и отображающие статус ID-карты, наличии импланта "Щит разума" и криминальном статусе.
# Corvax-Wega-End
