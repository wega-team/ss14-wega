...
uplink-syndicate-teleporter-desc = Экспериментальное ручное телепортирующее устройство. Телепортирует владельца вперёд на некоторое расстояние. Убедитесь что вы перемещаетесь не в стену.
