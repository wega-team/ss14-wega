...
public sealed partial class FoldableSystem : EntitySystem
{
    ...
    {
        if (!component.IsFolded && !component.CanFoldInsideContainer && _whitelistSystem.IsWhitelistFailOrNull(component.DeployedContainerWhitelist, args.Container.Owner))
            args.Cancel();
    }
