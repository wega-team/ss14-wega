...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        public void EnsureValid(ICommonSession session, IDependencyCollection collection, string[] sponsorPrototypes)
        {
            ...
            var maxOOCFlavorTextLength = configManager.GetCVar(WegaCVars.MaxOOCFlavorTextLength);
            if (OOCFlavorText.Length > maxOOCFlavorTextLength)
            {
                oocflavortext = FormattedMessage.RemoveMarkupOrThrow(OOCFlavorText)[..maxOOCFlavorTextLength];
            }
            else
            {
