...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile
    {
        ...
        public static string RandomBarkVoice()
        {
            var prototypeManager = IoCManager.Resolve<IPrototypeManager>();
            var random = IoCManager.Resolve<IRobustRandom>();
        ...
        public static HumanoidCharacterProfile Random(RandomizeCfg randomizeCfg, HumanoidCharacterProfile baseProfile)
        {
            ...
            profile.BarkVoice = (randomizeCfg & RandomizeCfg.Age) != 0 ? RandomBarkVoice() : baseProfile.BarkVoice; // Corvax-Wega-Barks
            profile.Height = (randomizeCfg & RandomizeCfg.Age) != 0 ? RandomHeight(speciesProto) : baseProfile.Height; // Corvax-Wega-Height
            profile.Status = Status.No; // Corvax-Wega
