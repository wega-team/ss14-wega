...
public sealed partial class BibleSystem : EntitySystem
{
    ...
    private void OnAfterInteract(Entity<BibleComponent> ent, ref AfterInteractEvent args)
    {
        ...
        // These fields were supposed to be lower down, but they got moved here.
        ...
        if (HasComp<UnholyComponent>(args.Target))
        {
            ...
            othersMessage = Loc.GetString(ent.Comp.DamageUnholyOthersText, ("user", userEnt), ("target", targetEnt), ("bible", ent));
            _popup.PopupEntity(othersMessage, args.User, Filter.PvsExcept(args.User), true, PopupType.MediumCaution);

            selfMessage = Loc.GetString(ent.Comp.DamageUnholySelfText, ("target", targetEnt), ("bible", ent));
        ...
        // string othersMessage; // Corvax-Wega-Vampire-Edit
        // string selfMessage; // Corvax-Wega-Vampire-Edit
