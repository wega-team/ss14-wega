...
public sealed partial class SpiderOSSystem : EntitySystem
{
    ...
    // Total ≈ 20 seconds across 14 phases.
    private static readonly int[] InitPhaseDelays =
    [
        1500,  // 0  Инициализация...
        2500,  // 1  Установка связи с нейронами...
        2000,  // 2  Расширение нейронной связи...
        2000,  // 3  Установка наблюдения...
        1500,  // 4  Активация механизма блокировки...
        1000,  // 5  Блокировка костюма...   (lock gear)
        500,   // 6  Успех.
        1500,  // 7  Персонализация костюма... (apply styles)
        500,   // 8  Успех.
        2500,  // 9  Инициализация модулей... (grant abilities)
        500,   // 10 Успех.
        1500,  // 11 Статус основных систем... ONLINE
        1500,  // 12 Статус резервных систем... ONLINE
        1000,  // 13 Все системы в норме.
    ];
