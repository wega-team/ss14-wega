...
public sealed partial class SiliconLawSystem : SharedSiliconLawSystem
{
    ...
    private void OnMidasTouchLawsAdded(Entity<SiliconLawProviderComponent> ent, ref SiliconVeilCultHackedEvent args)
    {
        ...
        NotifyLawsChanged(ent, new SoundPathSpecifier("/Audio/Misc/ratvar_reveal.ogg"));
    }
