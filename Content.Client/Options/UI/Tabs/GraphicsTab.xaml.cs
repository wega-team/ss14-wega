...
using Content.Shared.Visuals; // Corvax-Wega-Stylish
...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        // Corvax-Wega-Stylish-start
        Control.AddOptionDropDown(
            WegaCVars.StylishVisual,
            DropDownStylishType,
            [
                new OptionDropDownCVar<int>.ValueOption((int)StylishType.Current, Loc.GetString("ui-options-stylish-current")),
                new OptionDropDownCVar<int>.ValueOption((int)StylishType.Old, Loc.GetString("ui-options-stylish-old")),
                new OptionDropDownCVar<int>.ValueOption((int)StylishType.Event, Loc.GetString("ui-options-stylish-event")),
            ]);
        // Corvax-Wega-Stylish-end
        ...
        Control.AddOptionCheckBox(WegaCVars.PostProcess, PostProcessCheckBox); // Corvax-Wega-Postprocess
